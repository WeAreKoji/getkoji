-- Recreate get_creators_with_profiles function without redundant schema prefixes
-- This fixes PostgREST schema cache issue
CREATE OR REPLACE FUNCTION get_creators_with_profiles(
